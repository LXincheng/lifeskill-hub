...
- [x] 明亮/暗黑主题、统一语义色与精简控制台首页
- [x] 安全富文本阅读、友好来源链接、代码块与表格
- [x] 学习圈画、反馈与 AI 内容受控重生成
...
- [x] 学习进度和测验记录（路径勾选、阅读完成、测验得分，刷新恢复）
- [x] 对话直接生成结构化学习文件夹、路径、文章和测验
- [x] 对话历史列表、切换与删除
- [x] 学习主题按计划、知识、练习归纳；文件删除与内容类型边界明确
- [x] AI 文章/报告只读，批注和反馈独立持久化
- 复习任务

验收：M2 生成的学习内容可以记录完成状态、测验结果并形成复习任务。

完成记录（2026-08-28）：已完成进度和测验尝试的持久化 API，并将对话中的学习目标纳入受控 AgentRun。复习队列、学习卡片和多模态文件上传仍属于后续切片，不用空入口冒充已完成能力。
